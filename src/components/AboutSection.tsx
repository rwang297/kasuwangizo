    ...
    <section className="py-20 px-6 bg-white" ref={sectionRef}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative h-96 lg:h-[500px] rounded-3xl overflow-hidden border-8 border-teal-600">
              <Image
                src="https://cdn.builder.io/api/v1/image/assets%2F4390856dece946cfa9391a03f41a8205%2F774356a256ff47ad8b5b47fe1945751d?format=webp&width=800"
          ...
          >
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p>
                <span className="font-bold text-lg">K</span>asuwa Gizo is a Nigerian digital platform built to help small, medium, and micro businesses (MSMEs) gain the online visibility they deserve. We make it easy for local entrepreneurs, service providers, and shop owners to list their products, showcase their services, and share their business details — all in one trusted space where customers can easily find and contact them.
              </p>
