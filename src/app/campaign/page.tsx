    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex gap-6 mb-6">
            <div className="flex-shrink-0">
              <div className="w-32 h-32 bg-gray-200 rounded-lg overflow-hidden flex items-center justify-center">
                <img
                  src="https://images.unsplash.com/photo-1595777707802-91d177c547e1?w=200&h=200&fit=crop"
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 font-semibold mb-2">{businessInfo.description}</p>

              <p className="text-gray-700 text-sm mb-4 leading-relaxed max-w-2xl">
              ...
              <div className="flex items-center gap-6 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-600">({businessInfo.reviews} reviews)</span>
                </div>
        ...
        <div className="mt-8 bg-gray-900 text-white rounded-lg p-8 text-center">
          ...
          <p className="text-gray-300">This business is powered by MSME Hub - Africa's premier marketplace for small businesses</p>
        </div>
      </div>
    </div>
  );
